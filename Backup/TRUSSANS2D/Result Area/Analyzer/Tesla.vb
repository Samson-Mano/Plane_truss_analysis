...
Public Class Tesla
    ...
    '--- rests with the LORD <Proverb 21:31>
...
#End Region
    ...
    Private Sub CheckSupport(ByRef ChkFlg As Boolean)
        ...
        If I < 2 Then
            _updateStr = _updateStr & vbNewLine & " Checking Support" & _
             " ........................" & _
             " Failed" & _
                vbNewLine
            ChkFlg = True
    ...
    Private Sub CheckLoad(ByRef ChkFlg As Boolean)
        ...
        If I = 0 Then
            _updateStr = _updateStr & vbNewLine & " Checking Load" & _
             " ........................" & _
             " Failed" & _
                vbNewLine
            ChkFlg = True
...
#Region "Set Co-ordinates"
    Private Sub SetCoordinates(ByVal MaxDisp As Double)
        ...
        For Each R In _ResultMem
            RA2dt.Rmem.Add(New Rslt2DT(R._GResultMatrix(0), _
                                       R._GResultMatrix(1), _
                                       R._GResultMatrix(2), _
                                       R._GResultMatrix(3), _
                                       R._GNodeResultMatrix(0), _
                                       R._GNodeResultMatrix(1), _
                                       R._GNodeResultMatrix(2), _
